...
import { FaShoppingCart, FaWallet, FaHome, FaThList, FaCalendarAlt, FaShoppingBag, FaEnvelope, FaUtensils, FaBook, FaUsers } from 'react-icons/fa';
                ...
                <div className="drawer-side bg-[#D1A054] ">
                    ...
                    <ul className="menu p-4 w-80 h-full gap-2 bg-[#D1A054] text-base-content pt-10">
...

                        {
                            isAdmin ? <>
                                <li>
                                    <NavLink to='dashboard/home'><FaHome></FaHome> Adnin Home</NavLink>
                                </li>
                                <li>
                                    <NavLink to='dashboard/reservartion'><FaUtensils></FaUtensils>Add Item</NavLink>
                                </li>
                                <li>
                                    <NavLink to='dashboard/histroy'><FaWallet></FaWallet> Menage Item</NavLink>
                                </li>
                                <li>
                                    <NavLink to='dashboard/histroy'><FaBook></FaBook>Manage Booking</NavLink>
                                </li>
                                <li>
                                    <NavLink to='dashboard/allUsers'><FaUsers></FaUsers>All User</NavLink>
                                </li>
